          ...
          <div class="col-sm-12 col-md-9 col-lg-9">
            <div class="box">
              <h3>
                My Services
                <button
                  v-on:click="openServiceForm()"
                  v-if="!serviceForm"
                  class="float-right btn shadow-2 rounded px-3"
                >
                  <icon class="icon" icon="plus" />&nbsp; Create service
                </button>
                <button
                  v-on:click="openServiceForm()"
                  v-if="serviceForm"
                  class="float-right btn btn-danger shadow-2 rounded px-3"
                >
                  <icon class="icon" icon="times" />&nbsp; Close
                </button>
              </h3>
              <div class="row my-4" v-if="serviceForm">
                <div class="col-sm-12 radius-3 shadow-1 bg-white p-3">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <form method="post">
                        ...
                        <div class="form-group">
                          <label class="bold" for="description">Service description</label>
                          <vue-editor
                            id="editor"
